# **\[experimental\]** Create a controller with a LSF launcher.
...
WARNING: the `crew.cluster` LSF plugin is experimental and has not
actually been tested on a LSF cluster. Please proceed with caution and
