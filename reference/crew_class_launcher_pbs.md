...
See [`crew_launcher_pbs()`](crew_launcher_pbs.md).
...
Other pbs: [`crew_controller_pbs()`](crew_controller_pbs.md),
...
- [`crew_class_launcher_pbs$validate()`](#method-crew_class_launcher_pbs-validate)

- [`crew_class_launcher_pbs$script()`](#method-crew_class_launcher_pbs-script)
