# **\[maturing\]** Create an abstract cluster launcher object.

Create an `R6` abstract cluster launcher object.
...
- options_cluster:
  ...
  List of options from a `crew.cluster` options function such as
  [`crew_options_slurm()`](crew_options_slurm.md). Make sure the cluster
  types of the launcher and options function match.
...
This abstract class is used to develop specific launcher classes for
