...
See [`crew_launcher_lsf()`](crew_launcher_lsf.md).
...
Other lsf: [`crew_controller_lsf()`](crew_controller_lsf.md),
...
- [`crew_class_launcher_lsf$validate()`](#method-crew_class_launcher_lsf-validate)

- [`crew_class_launcher_lsf$script()`](#method-crew_class_launcher_lsf-script)
