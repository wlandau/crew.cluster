...
[`crew_controller_sge()`](reference/crew_controller_sge.md).
...
cluster jobs using [`crew_monitor_sge()`](reference/crew_monitor_sge.md)
and other supported monitors. Example for SGE:
...
- Most clusters install software like R in versioned environment
  ...
  e.g. [`crew_controller_sge()`](reference/crew_controller_sge.md).
